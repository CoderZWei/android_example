...
public class MyDialog extends DialogFragment implements View.OnTouchListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView=inflater.inflate(R.layout.dialog_layout,container);
        ...
        mImageView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Log.d("zw_debug","imageview touch");
        ...
        mBtn=(Button)mView.findViewById(R.id.close_btn);
        ...
        layoutParams.topMargin=pix2dip(162);
